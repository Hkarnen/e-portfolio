...
export default function About() {
    return (
       <section className="max-w-4xl mx-auto space-y-10">
        {/* Background */}
            <div>
                <h1 className="text-2x1 font-semibold mb-2">About Me</h1>
                <p>
                ...
                <div className="space-y-8">
                    <div className="flex flex-col md:flex-row gap-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mb-2">University of Melbourne x University of Eastern Finland (Mar 2025 - Present)</p>
